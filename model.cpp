...
void Model::quad(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2, GLfloat x3, GLfloat y3, GLfloat x4, GLfloat y4)
{
...
void Model::extrude(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2)
{
